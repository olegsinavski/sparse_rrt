...
class SST(_sst_module.SSTWrapper):
    def visualize_tree(self, system):
        return render_svg(_sst_module.SSTWrapper.visualize_tree(self, system))

    def visualize_nodes(self, system):
        return render_svg(_sst_module.SSTWrapper.visualize_nodes(self, system))


class RRT(_sst_module.RRTWrapper):
    def visualize_tree(self, system):
        return render_svg(_sst_module.RRTWrapper.visualize_tree(self, system))

    def visualize_nodes(self, system):
        return render_svg(_sst_module.RRTWrapper.visualize_nodes(self, system))
